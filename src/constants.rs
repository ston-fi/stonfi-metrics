...
pub static DURATION_BUCKETS_1MS_20S: LazyLock<Vec<f64>> = LazyLock::new(|| exponential_buckets(1.0, 3.01, 10)); // 1*(3.01^9) = 20281
/// Exponential duration buckets in milliseconds from 0.1ms to about 20s.
pub static DURATION_BUCKETS_01MS_20S: LazyLock<Vec<f64>> = LazyLock::new(|| exponential_buckets(0.1, 3.89, 10)); // 0.1*(3.89^9) = 20396
